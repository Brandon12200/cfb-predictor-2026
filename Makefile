...
LINT_PATHS := main.py data/team_registry.py data/data_manager.py data/schedule_intel.py data/odds_budget.py data/clients data/normalize data/snapshot utils/season_calendar.py tests/conftest.py tests/test_week_inference.py tests/test_cfbd_v2_client.py tests/test_team_registry.py tests/test_registry_reconciliation.py tests/test_odds_client.py tests/test_normalize.py tests/test_snapshot.py tests/test_no_network.py tests/test_market_sentiment.py tests/test_schedule_intel.py tests/test_inspection.py tests/test_lines.py tests/context_factory.py
TYPED_PATHS := data/team_registry.py data/data_manager.py data/schedule_intel.py data/odds_budget.py data/clients/cfbd_v2.py data/clients/odds.py data/normalize data/snapshot utils/season_calendar.py
