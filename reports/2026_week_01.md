...
_11/11 games graded. Model: v2026-frozen-3-23-g7485244 (schema v2), year 2026._
...
_**These are hypothetical leans, not placed bets.** All 4 graded games were NO_BET — this is what the model would have done had it bet, which is how selectivity gets measured (3c.5). No wager was recommended._

| lean | leans | graded | W-L-P | ATS win% | Wilson 95% | avg CLV |
|---|---|---|---|---|---|---|
| home | 4 | 4 | 1-3-0 | 25.0% | [5%–70%] | -0.33 pts (beat close 0.0%, n=4) |
| away | 0 | 0 | 0-0-0 | — | — | — (no games on this side) |
| _naive: always lean home_ | 4 | 4 | 1-3-0 | 25.0% | [5%–70%] | -0.33 pts (beat close 0.0%, n=4) |

_Model 25.0% vs naive baseline 25.0% on the same games: **+0.0%** — **at or below** always taking the home team._
...
|---|---|---|
| placed bets | 0 | — |
| NO_BET (hypothetical lean) | 4 | 25.0% |
