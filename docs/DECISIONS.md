...
6. **`StyleMismatch` (3c.10) resolved** — pace component **dormant** (per-game data not in the factor's payload; the raw-total comparison was a phantom), range **±4.0 → ±1.5** (0.6× HFA), confidence bands rescaled. Calibration → **RATIFIED** (owner, 2026-07-04) in CALIBRATION_LOG Phase 3d (3d.2–3d.4).
