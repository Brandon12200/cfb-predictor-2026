...
5. **Confidence calculator v2 per L3.** Map confidence to explicit tiers (e.g., A/B/C) with defined score ranges; tiers appear in output and reports. Calibration of tier boundaries happens before freeze using 2025 data.
